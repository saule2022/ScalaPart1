...
class House(var name:String,
  ...
  val volume:Double = levels*floorHeight*width*houseLength //this does not cover attic and basement
  ...
  //inside the constructor we put the things we want done upon initialization
...
//from com.github.ValRCS.Day12Classes definition
object Day12Classes extends App {
  ...
  val myPlainHouse = new PlainHouse //this creates an object instances out of com.Github.saule2022.PlainHouse blueprint
  println(myPlainHouse)
  val anotherPlainHouse = new PlainHouse //this is a second object out of our com.Github.saule2022.PlainHouse class blueprint
  println(anotherPlainHouse)

  val myHouse = new House("countryHouse", 2, "wood",5,6)
  myHouse.prettyPrint()
  println(myHouse)
  ...
  val strawHouse = new House("piggyHouse", 1, "Straw",houseLength = 3.2)
  ...
  strawHouse.updateSecurityKey("Password")
  ...
  println(s"Straw house volume is ${strawHouse.volume}")
