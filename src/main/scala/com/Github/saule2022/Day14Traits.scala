...
class KittyPet extends Pet {
  ...
  override def speak():Unit = println("Meow") //// Unit-does something, but doesnt return anything!!!!!!!!!!
  //comeToMaster had to be made in any case
  override def comeToMaster():Unit = println("Meow, murrr, murrr!")
}
