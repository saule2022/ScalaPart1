...
object Day11Sets extends App {
  ...
  //if symmetrical difference does not exist in Scala collection we can make it really easily ourselves by  creating a union of BOTh differences we took earlier
  println("union- symetrical dfference")
  ...
  println("unique abracadabra set: ")
